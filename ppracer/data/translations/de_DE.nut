...
Translation.set("Practice","Training");
Translation.set("Configuration","Konfiguration");
Translation.set("Credits","Mitwirkende");
Translation.set("Quit","Beenden");
...
Translation.set("Brake:","Bremsen:");
Translation.set("Jump:","Springen:");
//Translation.set("Trick:","Trick:");
Translation.set("Reset:","Zurücksetzen:");
...
Translation.set("Time:","Zeit:");
Translation.set("Herring:","Heringe:");
Translation.set("Score:","Punkte:");

//event select
Translation.set("Continue","Weiter");
...
//race over
Translation.set("Race Over","Rennen vorbei");
Translation.set("Time: %02d:%02d.%02d","Zeit: %02d:%02d.%02d");
Translation.set("Herring: %3d","Heringe: %3d");
Translation.set("Score: %6d","Punkte: %6d");
...
//Credits
Translation.set("Development Team","Entwickler");
Translation.set("Translators","Übersetzer");
Translation.set("Contributors","Mitwirkenden");
Translation.set("Tux Racer Development Team","Tux Racer Entwickler Team");
Translation.set("Music","Musik");
Translation.set("Thanks To:","Dankschö:");
