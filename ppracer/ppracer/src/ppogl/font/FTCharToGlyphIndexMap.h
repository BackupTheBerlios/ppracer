...
#ifndef __PPOGL_FTCHARTOGLYPHINDEXMAP_H_
#define __PPOGL_FTCHARTOGLYPHINDEXMAP_H_
...
public:
	...
	GlyphIndex find(CharacterCode c) const
	{
		if(!this->Indices){
			return 0;
		}
...
#endif // __PPOGL_FTCHARTOGLYPHINDEXMAP_H_
