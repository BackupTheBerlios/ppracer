tux_course_light 0 -on -position { 1 1 1 0 } -diffuse { 0.55 0.43 0.47 1 } \
     -specular { 0.3 0.3 0.3 1 } -ambient { 0.50 0.4 0.40 1.0 }
...
tux_fog -on -mode linear -start -10 -end $fog_dist -color { 0.80 0.50 0.40 1.0 }
