tux_course_light 0 -on -position { 1 1 0 0 } -diffuse { 0.88 0.51 0.31 1 } \
     -specular { 0.0 0.0 0.0 1 } -ambient { 0.34 0.09 0.4 1.0 }
     
#tux_course_light 1 -on -position { 1 1 1 0 } -specular { 0.8 0.8 0.8 1 } 

tux_course_light 1 -on -position { 1 1 1 0 } -specular { 1 1 1 1 }

tux_fog -on -mode linear -density 0.005 -color { 0.30 0.09 0.0 1 } -start 0 \
