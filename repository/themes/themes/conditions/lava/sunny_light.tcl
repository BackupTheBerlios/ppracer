tux_course_light 0 -on -position { 1 1 0 0 } -diffuse { 1.0 0.95 0.95 1 } \
     -specular { 0.0 0.0 0.0 1 } -ambient { 0.70 0.53 0.50 1.0 }

tux_course_light 1 -on -position { 1 1 2 0 } -specular { 0.9 0.75 0.7 1 } 

tux_fog -on -mode linear -density 0.005 -color { 1.0 0.9 0.9 1 } -start 0 \
